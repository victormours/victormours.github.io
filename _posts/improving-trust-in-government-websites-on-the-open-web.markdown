...
- Scammers are trying to impersonate government websites, usually to get people to pay a bogus fine
- This can result in people being less trusting of government websites.
As and example, let's take a look at the initial experience for the French government service France Identités:
...
Anyone could spoof the design system used by the French government

In turn, government can be discouraged from communicating with their citizens through the open web, and try to find channels of communications that are deemed more trustworthy, which could drive them to

I believe that it doesn't have to be this way, and that with a few simple design changes, we could make government websites and services easier to identify reliably on the open web, thus making them more trustworth.

## Disclaimer

At this point, I should disclose that I have a horse in this race, since I am working on a web app for the French government as an independent contractor. My work is open source and publicly available on my Github profile, as is the norm for the agency I work with. However, I am making this proposal as a private citizen and open source contributor, on my own time. The ideas and opinions expressed here are my own, and are all based on publicly available information.
...
This doesn't make it easy to spot, as Tim Berners-Lee himself famously says so in his FAQ on the World Wide Web Consortium website :
...
(source https://www.w3.org/People/Berners-Lee/FAQ.html#etc)
